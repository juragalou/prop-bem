...
Rtot = 0.5  # m
u_0 = 10  # m/s
omega = 2 * np.pi * 0.2  # rad/s
R = np.linspace(0.125, Rtot, 10) # m
c = 0.15  # m
rho = 1.225  # kg/m^3
B = 2 # number of blades
beta = 25 * np.pi / 180  # radians
...
print("Axial induction factors:", solutions_a)
print("Tangential induction factors:", solutions_A)
...
def K_t(n , Vmax):
    ...
    """
    K_t_values = []
    for v in np.linspace(0, Vmax, 10):
        J = v / (n * 2 * Rtot)
